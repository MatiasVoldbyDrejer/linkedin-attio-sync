...
// Lucide glyphs (ISC), inlined because lucide-react is a dependency of the UI package, not of this app
...
export function UserSearchIcon(props: ComponentProps<'svg'>) {
  return (
    <Icon {...props}>
...
export function RotateIcon(props: ComponentProps<'svg'>) {
  return (
    <Icon {...props}>
